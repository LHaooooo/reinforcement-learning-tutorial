...
├── requirements.txt
│
├── 01_basics/                     # 基础理论（只有 md）
│   ├── 1.1_reinforcement_learning_intro.md
│   ├── 1.2_elements_of_rl.md
│   ├── 1.3_classification_of_rl.md
│   └── 2.1_markov_decision_process.md
│
├── 02_tabular_methods/
│   ├── theory.md
│   └── q_learning.py
...
├── 06_offpolicy_rl/
│   ├── theory.md
│   ├── sac_tutorial.md          # ★ SAC 专题长文（见本 README 后半部分）
│   ├── ddpg_pendulum.py
│   ├── td3_pendulum.py
│   └── sac_pendulum.py
│
├── 07_representation_rl/
│   ├── theory.md
│   └── rlpd_pendulum.py
│
├── 08_evaluation_and_tools/
│   ├── theory.md
│   ├── evaluate_policy.py
│   └── common/
│       ├── env_utils.py
